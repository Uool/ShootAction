...
{
    private Dictionary<Type, HashSet<IMessageExchangeTarget>> targets =
        new Dictionary<Type, HashSet<IMessageExchangeTarget>>();

    private Dictionary<String, int> Testdic = new Dictionary<string, int>();
